...
@Getter
@Setter
@GroupSequence({UpdateBakeTicketCustomerDto.class, SecondValidation.class, ThirdValidation.class, FourthValidation.class, FifthValidation.class})
public class UpdateBakeTicketCustomerDto implements Dto {
