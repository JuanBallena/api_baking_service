...
import com.jp.baking.service.annotation.UniqueNumberAttentionToUpdate;
...
@Getter
@Setter
@GroupSequence({UpdateBakeTicketDto.class, SecondValidation.class, ThirdValidation.class, FourthValidation.class, FifthValidation.class})
public class UpdateBakeTicketDto implements Dto {
	...
	@UniqueNumberAttentionToUpdate(groups = FifthValidation.class)
	private HashMap<String, Object> getNumeroAtencion() {
		
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("idBakeTicket", this.idBakeTicket);
